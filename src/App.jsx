    ...
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        <div className='animate__animated animate__fadeInUp animate__delay-3s'>
          <div className="flex items-center gap-3 mb-0 bg-zinc-800 w-fit p-4 rounded-2xl">
            <img src={DataImage.HeroImage} alt="Hero Image" className="w-10 rounded-md" loading='lazy'></img>
            <q>Kode yang indah, lahir dari ketekunan😁</q>
          </div>
          <h1 className="text-5xl/tight font-bold mb-6">Hi, Saya Ahmad Dimasyqi Yahya</h1>
          <p className="text-base/loose mb-6 opacity-50 text-justify">
            Saya seorang pengembang perangkat lunak yang berdedikasi untuk menciptakan solusi inovatif dan efisien.
            <br />
            Berpengalaman dalam pengembangan aplikasi web, mobile, dan backend. 
            Selalu bersemangat mempelajari teknologi baru dan berkolaborasi dalam tim untuk menghasilkan produk berkualitas.
            <br />
            Saya percaya bahwa teknologi dapat memberikan dampak positif bagi kehidupan banyak orang. 
            Dengan pengalaman di berbagai proyek, saya terbiasa menghadapi tantangan dan mencari solusi kreatif.
            <br />
            Komitmen saya adalah terus belajar, berbagi pengetahuan, dan berkontribusi dalam komunitas pengembang. 
            Mari bersama-sama membangun masa depan yang lebih baik melalui inovasi digital!
          </p>
        ...
        <img src={DataImage.HeroImage} alt="HeroImage" className="w-[500px] md:ml-auto animate__animated animate__fadeInUp animate__delay-4s" loading='lazy'></img>
      </div>
      ...
      <div className="tentang mt-32 py-10" id='tentang'>
        ...
        <img src={DataImage.HeroImage} alt="Image" className="w-12 rounded-md mb-10 sm:hidden" loading='lazy'></img>
          <p className="text-base/loose mb-10">
            Hi, perkenalkan saya Ahmad Diamsyqi Yahya, seorang Full Stack Web Developer dan Designer untuk UI/UX Design maupun Product Digital, 
            Saya percaya bahwa desain dan fungsionalitas harus berjalan beriringan, sehingga setiap proyek yang saya kembangkan tidak hanya terlihat menarik tetapi juga memberikan pengalaman pengguna yang optimal.
          </p>
      ...
      <div className="kontak mt-32 sm:p-10 p-0" id='kontak'>
        ...
        <form action="https://formsubmit.co/ahmaddimasyqi10@gmail.com" method="POST" className='bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-md autoComplete="off' data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
